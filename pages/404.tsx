...
const notFound = () => {
    return (
        ...
        <div className="h-screen text-center flex flex-col items-center justify-center"> 
            ...
            <p className="text-xs md:text-base font-light text-gray-700 mt-2">Stay tuned. We are launching soon. We are working hard. We are almost ready to launch. Something awesome is coming soon. Be first to know.
</p>
